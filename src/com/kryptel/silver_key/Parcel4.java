...
final class Parcel4 implements ISilverKeyParcel {
	Parcel4(long capabilities) throws Exception {
  ...
  //
	...
	private static final short ENGINE_VERSION_CREATED				= Engine4.ENGINE_VERSION;
	...
	private void WriteHeader() throws Exception {
		...
		Store(Write, Conversions.UuidToBytes(CID_SILVER_KEY_4));
