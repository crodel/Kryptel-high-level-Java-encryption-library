...
final class Engine4 implements IKryptelComponent,
	...
	Engine4(long capabilities) throws Exception {
		compCapabilities = capabilities;
		parcelCreator = new Parcel4(capabilities);
		parcelExtractor = new Extractor4(capabilities);
	}
	...
	public String ComponentName() { return "Silver Key 4 Legacy Engine"; }
	...
	public IKryptelComponent Clone() throws Exception {
		return new Engine4(compCapabilities);
	}
  ...
  static UUID componentID = CID_SILVER_KEY_4;

	private long compCapabilities = CAP_DEFAULT_CAPABILITIES;
	
	private Parcel4 parcelCreator;
	private Extractor4 parcelExtractor;
}
