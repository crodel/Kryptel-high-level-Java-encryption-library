...
final class Sha1 extends HashBase {
	Sha1(long capabilities) throws Exception {
		super(capabilities);
	...
	public String ComponentName() { return "SHA-1"; }
  ...
  static UUID componentID = CID_HASH_SHA1;
	
	private static final int HASH_SIZE = 160 / 8;
	
	
	//
	// Actual SHA-1 implementation
	//
